...
#     oob = scales::squish,
  ...
  annotate("text", x = -122.44, y = 47.6, label= "Seattle", size = 4) + 
  #    xlab("Longitude")+ ylab("Latitude") + 
  theme_void() + 
  theme(panel.grid.major = element_blank(), panel.background = element_rect(fill = "aliceblue"), 
        panel.border = element_rect(fill = NA)) 
...
ggdraw(xlim = c(0, 28), ylim = c(0, 20)) +
  ...
  draw_plot(SEWA, x = 14, y = 11.25, width = 12, height = 8) +
  draw_plot(TAWA, x = 14, y = 2.5, width = 12, height = 8) +
