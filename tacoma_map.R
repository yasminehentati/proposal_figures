...
arrowA <- data.frame(x1 = 9, x2 = 16, y1 = 9.5, y2 = 14.5)
arrowB <- data.frame(x1 = 9, x2 = 16, y1 = 8.5, y2 = 5.5)
...
ggdraw(xlim = c(0, 28), ylim = c(0, 20)) +
  ...
  draw_plot(SEWA, x = 14, y = 10, width = 12, height = 10) +
  draw_plot(TAWA, x = 14, y = 0, width = 12, height = 10) +
...
library(cowplot)
top_row <- cowplot::ggdraw(xlim = c(0, 28), ylim = c(0, 20)) +
#   draw_plot(washington, x = 0, y = 0, width = 13, height = 20) +
  draw_plot(SEWA, x = 14, y = 10, width = 12, height = 10) +
  draw_plot(TAWA, x = 14, y = 0, width = 12, height = 10) +
  geom_segment(aes(x = x1, y = y1, xend = x2, yend = y2), data = arrowA, 
